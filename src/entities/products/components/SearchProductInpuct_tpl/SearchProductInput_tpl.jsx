...
function SearchProductInput_tpl({onfilter, state}) {
  const [setSearchInputValue,searchInputValue]=state
  return (
    <div className="form__search">
        <input
        onChange={e=> setSearchInputValue(e.target.value)}
        value={searchInputValue}
         className='form__search-input' type="text" placeholder='Поиск...'/>
        <div onClick={()=> onfilter()} className="form__search-icon">
